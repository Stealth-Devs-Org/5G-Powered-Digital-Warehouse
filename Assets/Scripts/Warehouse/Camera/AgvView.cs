...
public class AgvView : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Switch to the next AGV when '3' is pressed
        if (Input.GetKeyDown(KeyCode.Alpha1) && AGVs.Count > 0  && !Input.GetKeyDown(KeyCode.Space) && !Input.GetKeyDown(KeyCode.Alpha2) && !Input.GetKeyDown(KeyCode.Alpha3)&& !Input.GetKeyDown(KeyCode.Alpha4))
        {
            currentAgvIndex = (currentAgvIndex + 1) % AGVs.Count;
        ...
        if (Input.GetKeyDown(KeyCode.Space) || Input.GetKeyDown(KeyCode.Alpha2)|| Input.GetKeyDown(KeyCode.Alpha3)|| Input.GetKeyDown(KeyCode.Alpha4))
        {
